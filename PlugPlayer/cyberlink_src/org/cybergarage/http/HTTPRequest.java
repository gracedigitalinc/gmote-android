...
public class HTTPRequest extends HTTPPacket
{
	...
	public static String UserAgent = "Unknown/1.0";
	...
	{
		return post( httpRes, 0 );
	}

	public boolean post(HTTPResponse httpRes, long currentPos)
	{
		HTTPSocket httpSock = getSocket();
		long offset = 0;
		long length = httpRes.getContentLength();
		if ( hasContentRange() == true && httpRes.getStatusCode() != HTTPStatus.INVALID_RANGE )
		{
