...
public class ControlPoint implements HTTPRequestListener
{
	...
	private final SSDPNotifySocketList ssdpNotifySocketList;
	private final SSDPSearchResponseSocketList ssdpSearchResponseSocketList;
	...
	public void addDevice( Node rootNode )
	{
	...
	private final ListenerList deviceNotifyListenerList = new ListenerList();
	...
	private final ListenerList deviceSearchResponseListenerList = new ListenerList();
	...
	private final HTTPServerList httpServerList = new HTTPServerList();
