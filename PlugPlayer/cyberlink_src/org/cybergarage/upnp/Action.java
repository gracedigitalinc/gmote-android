...
public class Action
{
	...
	public void PrintInputArgumentList( ArgumentList allArgList )
	{
		...
		{
			Argument arg = allArgList.getArgument( n );
			System.out.println( "Name :" + arg.getName() + " value : " + arg.getValue() );
		}
		return;
	}
	...
	private void setActionRequest( ActionRequest actionReq )
	{
	...
	public boolean postControlAction()
	{
		...
		PrintInputArgumentList( actionArgList );
		...
		System.out.println( "postControlAction output:" + outArgList.toString() );
		PrintInputArgumentList( outArgList );
		try
		{
	...
	private final UPnPStatus upnpStatus = new UPnPStatus();
