...
public class TouchListView extends ListView
{
	...
	/*
	 * Adjust visibility and size to make it appear as though an item is being dragged around and other items are making room for it: If dropping the item would
	 * result in it still being in the same place, then make the dragged listitem's size normal, but make the item invisible. Otherwise, if the dragged listitem
	 * is still on screen, make it as small as possible and expand the item below the insert point. If the dragged item is not on screen, only expand the item
